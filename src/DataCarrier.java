...
public class DataCarrier {
    ...
    public  String getValue() {
        ...
        int method_id = calculateMethodIdFromState();
        String method_name = "getV" + method_id;
        String result = "";

        try{
            Method m = DataCarrier.class.getDeclaredMethod(method_name);
    ...
    public  void setValue( String sV ) {
		...
		int method_id = calculateMethodIdFromState();
        String method_name = "setV" + method_id;

        try{
            Method m = DataCarrier.class.getDeclaredMethod(method_name, String.class);
            m.setAccessible(true);
            m.invoke(this, sV);
            m.setAccessible(false);
        }catch (NoSuchMethodException | IllegalAccessException | InvocationTargetException e){
    ...
    private int calculateMethodIdFromState(){
        int method_id = this.getP0() + this.getP1()*2 + this.getP2()*4 + this.getP3()*8 + this.getP4()*16;
        return method_id;
    }
}